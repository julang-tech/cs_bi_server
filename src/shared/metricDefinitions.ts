...
export const METRIC_DEFINITION_GROUPS: MetricDefinitionGroup[] = [
  ...
  },
  {
    id: 'p2',
    title: 'P2 退款情况看板',
    description: '订单、销售、退款规模、退款占比和商品退款表现。数据有 1 天延迟（每天凌晨 3 点回写）。',
    sections: [
      {
        title: '核心 KPI',
        items: [
          {
            id: 'p2.order_count',
            name: '订单数',
            short: '统计周期内的常规订单去重数量。',
            detail:
              '排除礼品卡订单和测试 / 内部订单。店铺和商品筛选会缩小订单集合。',
          },
          {
            id: 'p2.sales_qty',
            name: '销量',
            short: '统计周期内售出的商品件数（订单内每件商品数量之和）。',
            detail:
              '排除非商品行：保险、运费、价差等。一单买 2 件 T 恤 + 1 条裤子销量 = 3。',
          },
          {
            id: 'p2.refund_order_count',
            name: '退款订单数',
            short: '统计周期内有发生退款的订单数（去重）。',
            detail:
          ...
          },
          {
            ...
            detail:
              '按退款实际发生的日期统计，金额按订单当时的汇率折算成美元后合计。',
          },
          {
            id: 'p2.gmv',
            name: 'GMV',
            short: '订单成交金额，含运费，按美元合计。',
            detail:
              '客户实际下单的金额（含运费），不扣退款。排除礼品卡订单。',
          },
          {
            id: 'p2.net_received_amount',
            name: '净实付金额',
            short: '客户实际支付到账的收入（含运费），按美元合计。',
            detail:
              '是"退款金额占比"的分母——衡量退款相对真实进账的压力。',
          },
          {
            id: 'p2.net_revenue_amount',
            name: '净 GMV',
            short: '订单 GMV 扣减退款后的净收入，按美元合计。',
            detail:
              '观察退款后真正留在公司账上的金额。',
          },
          {
            ...
            detail:
              '衡量退款相对销售收入的压力。**注意**：分子是这段时间内"发生的退款"，分母是这段时间内"产生的销售"——这两批订单不一定是同一批（退款可能针对几周前的订单）。所以这个比值更适合看趋势，而不是绝对值精确归因。',
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            detail:
              '展开 SPU 可见各 SKC 明细。筛选后会按筛选条件重新拉 Top50。',
          },
          {
